class NumberContainers:
    ...
    def change(self, index: int, number: int) -> None:
        ...
        if index in self.index_to_number:
            self.number_to_index[self.index_to_number[index]].remove(index)
            if not self.number_to_index[self.index_to_number[index]]:
                del self.number_to_index[self.index_to_number[index]]
